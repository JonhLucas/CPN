...
for(i = 1 : jogadas)
    ...
    if(m(l,c)==0)
      ...
      elseif(aux(l,c) == 2 && ocupados(l-1,c) == 1)
          if(ocupados(l+1,c) && aux(l+1,c) ==  3)
              img((l-2)*10+1:(l-2)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
              img((l-1)*10+1:(l-1)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
              img(l*10+1:l*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
          elseif(aux(l+1,c) ~=  3)
              img((l-2)*10+1:(l-2)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
      ...
      elseif(aux(l,c) == 3 && ocupados(l-1,c) == 1 && ocupados(l-2,c) == 1)
          img((l-3)*10+1:(l-3)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
          img((l-2)*10+1:(l-2)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
          img((l-1)*10+1:(l-1)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
      elseif(aux(l,c) == 7 && ocupados(l,c-1) == 1 && ocupados(l,c-2) == 1)
          img((l-1)*10+1:(l-1)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
          img((l-1)*10+1:(l-1)*10+9,(c-2)*10+1:(c-2)*10+9) = 0.9;
          img((l-1)*10+1:(l-1)*10+9,(c-3)*10+1:(c-3)*10+9) = 0.9;
      elseif(aux(l,c) == 6 && ocupados(l,c-1) == 1)
          if(ocupados(l,c+1) && aux(l,c+1) == 7)
              img((l-1)*10+1:(l-1)*10+9, c*10+1:c*10+9) = 0.9;
              img((l-1)*10+1:(l-1)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
              img((l-1)*10+1:(l-1)*10+9,(c-2)*10+1:(c-2)*10+9) = 0.9;
          elseif(aux(l,c+1) ~=  7)
              img((l-1)*10+1:(l-1)*10+9,(c-2)*10+1:(c-2)*10+9) = 0.9;
      ...
      elseif(aux(l,c) == 5 && ocupados(l,c+1) == 1)
          if(ocupados(l,c+2) && aux(l,c+2) == 7)
              img((l-1)*10+1:(l-1)*10+9,(c-1)*10+1:(c-1)*10+9) = 0.9;
              img((l-1)*10+1:(l-1)*10+9,c*10+1:c*10+9) = 0.9;
              img((l-1)*10+1:(l-1)*10+9,(c+1)*10+1:(c+1)*10+9) = 0.9;
          elseif(aux(l,c+2) ~=  7)
